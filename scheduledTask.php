...
<body>
    ...
    <section class="contentHeader">
        <div class="breadcrumbTitle">
            ...
            <span class="title">Add Scheduled Cleaning</span>
        </div>
    </section>
                    ...
                    <div class="col-md-8 col-lg-9">
                        <form class="inBodyForm form-horizontal">
                            <div class="form-group">
                                <label class="col-md-4 control-label">Task Group</label>
                                <div class="col-md-3">
                                    <input type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Assign Reccurence</label>
                                <div class="col-md-2">
                                    <div class="select">
                                        <select>
                                            <option>Daily</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text">
                                    <span class="addButton"><img src="images/plus.svg" class="svg"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Assign Area</label>
                                <div class="col-md-2">
