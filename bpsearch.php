...
<body>
    ...
    <section class="contentHeader">
        ...
        <div class="clearfix">
            ...
            <button type="button" class="defaultButton">Reset Sorting</button>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>120</td>
                            <td>80</td>
                            <td class="desc">Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</td>
                            <td>Harry McGuinness</td>
