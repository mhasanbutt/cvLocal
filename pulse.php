            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 text-right">
                        ...
                        <div id="tester" class="graphs text-center" style="width: 100%; height:250px;"></div>
                        <div class="pull-right" style="width: 100%; max-width: 391px;">
                            <hr>
                            <h5 class="inPageLinksTitle text-left">Service User Hub</h5>
