...
<body>
    ...
    <section class="videoPop">
        <i class="closePop"></i>
        <span class="title">Interacting with BMI Module</span>
        
        <div class="videoPlaceHolder">
            <iframe width="478" height="292" src="https://www.youtube.com/embed/UCIpwe3F3Nk?si=5vLTlQM7fJFRdiFX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        
        <ul class="videoTabs">
            <li class="active" id="otherVidz">Other Videos</li>
            <li id="docs">Documents</li>
            <li id="pics">Pictures</li>
        </ul>
        
        <div class="videoTabSection">
            <div class="scrollArea">
                <ul class="videoList active" id="otherVidzSection">
                    <li>
                        <span class="img"></span>
                        <span class="title">how to Add new BMI Record</span>
                        <p>Nullam et lacus ut arcu fringilla laoreet sed ac nisi. Suspendisse quis scelerisque velit, quis porttitor sapien.</p>
                    </li>
                </ul>
                <ul id="docsSection">
                    <li>
    ...
    <section class="contentHeader">
        ...
        <div class="filtersSearch clearfix autoWidth">
            ...
            <button class="needHelp help icon" style="background-image:url('images/eMarMoreInfo.png');">Need Help?</button>
        </div>
    </section>
    ...
    <script>
        ...
        $('.videoTabs li').click(function () {
            ...
            if (!$(this).hasClass('active')) {
                ...
                $(this).parent().siblings('.videoTabSection').find('ul').removeClass('active');
                $('#' + t + 'Section').addClass('active');
            }
        });
    </script>
</body>
