...
<body>
    ...
    <section class="contentHeader">
        <div class="breadcrumbTitle">
            ...
            <span class="title">Task(s) Created</span>
        </div>
        ...
        <div class="clearfix">
            ...
            <div class="pull-right clearfix">
                <div class="btn-group noAlergy">
                    <button type="button" class="btn orange"><img src="images/plus.svg" class="svg">Add Scheduled Task</button>
                    <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="caret"></span>
                        <span class="sr-only">Toggle Dropdown</span>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a href="#">Add Deep Cleaning Task</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Floor 2</td>
                            <td>A-11</td>
                            <td>Empty the Bins</td>
                            <td>Weekly</td>
                            <td>admin232</td>
                            <td>
                            	<button class="btn orange positionTest" id="">Add</button>
                            	<div class="smallpopUp">
                                    <span class="closeThis pull-right"><img src="images/close.svg" class="svg"></span>
                            		<ul class="list-unstyled">
                            			<li><a href="#">Convert to Pre-Admission assessment</a></li>
                            			<li><a href="#">Convert to Feedback Form</a></li>
                            			<li><a href="#">Convert to Enquiry Assessment</a></li>
                            		</ul>
                            	</div>
                            </td>
    ...
    <script>
        ...
        $('.positionTest').click(function(e) {
            $('.smallpopUp').removeClass('show');
            $(this).parent("td").children(".smallpopUp").addClass('show');
        });

        $('.smallpopUp .closeThis').click(function() {
