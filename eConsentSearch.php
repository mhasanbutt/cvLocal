...
<body>
    ...
    <section class="contentHeader">
        <div class="breadcrumbTitle">
            ...
            <span class="title">eConsent Search</span>
        </div>
        ...
        <div class="scrollArea">
            <div class="content">
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <th>Requested Consent</th>
                            <th>Approval Medium</th>
                            <th>Request Date</th>
                            <th>Approval Date</th>
                            <th>Service User</th>
                            <th>Due Date</th>
                    ...
                    <tbody>
                        <tr>
                            <td>Bed Rails</td>
                            <td>Email, Send via App, Phone Call</td>
                        ...
                        <tr class="danger">
                            ...
                            <td>2017-06-21 00:00:00</td>
                            <td><a href="#" class="view"><img src="images/view.svg" class="svg"></a></td>
                            <td><span class="pending"><img src="images/exclamation-mark.svg" class="svg"></span></td>
                        </tr>
                        <tr>
                            <td>Hospital Appointment (Escort)</td>
                            <td>Email, Send via App, Phone Call</td>
                            <td>2017-06-21 00:00:00</td>
                            <td>2017-06-21 00:00:00</td>
                            <td>Terrance Edwards</td>
