...
<body>
    ...
    <section class="contentHeader">
        ...
        <div class="clearfix" style="margin-top:20px;">
            ...
            <div class="pull-right clearfix">
                ...
                <div class="btn-group">
                    <button type="button" class="btn"><img src="images/plus.svg" class="svg">Generate New Order</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="contentBody">
        <div class="scrollArea">
            <div class="content">
                <div class="orderInfo">
                    <span>Date Ordered: <strong>28-09-2017</strong></span>
                    <span>Order Status: <strong>Complete</strong></span>
                    <span>Date Received: <strong>30-09-2017</strong></span>
                    <span>Source of Medicine: <strong>Pharmacy - Online Order</strong></span>
                </div>
    ...
    <section class="contentFooter">
        <div class="row">
            <div class="col-md-8">
                <button>back</button> <button class="completed">Update</button>
            </div>
        </div>
    </section>
