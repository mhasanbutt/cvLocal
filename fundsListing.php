...
<body>
    ...
    <section class="contentHeader">
        ...
        <div class="searchFilterDetails">
            <div class="balance"><span>Balance <strong>&pound;2211.33</strong></span></div>
            <div class="selection" id="ShowFilterSelection"><span>Home <strong>Oatlands Care ltd.</strong></span> <span>Floor <strong>Floor 1</strong></span></div>
        </div>
    </section>
    ...
    <section class="contentBody noBg noFooter">
        <div class="scrollArea">
            <div class="content" style="overflow: hidden;">
                <ul class="list-unstyled clearfix fundsList">
                    <li>
                        <article>
                            <a href="fundsIndividual.php" class="clearfix">
                                <img src="images/temp-picture.jpg">
                                <span class="name">Bidwell Fredrick</span>
                                <span class="nickName">Freddy</span>
                                <span class="room">Room 1</span>

                                <div class="balance">
                                    <span>&pound;131.70 <i>Current Balance</i></span>
                                    <span class="red">-100.00 <i>Last Funds In / Out</i></span>
                                </div>
                            </a>
                        </article>
                    </li>
