...
<body>
    ...
    <section class="contentHeader">
        <div class="breadcrumbTitle">
            ...
            <span class="title"><img src="images/funds.png" alt=""> Resident Funds Account</span>
        </div>
        <div class="filtersSearch clearfix autoWidth">
            ...
            <a class="new icon" href="#">New</a>
        </div>
    </section>

    <section class="contentBody noBg noFooter">
        <div class="usrBalance">
            <span class="user">
                <img src="images/temp-picture.jpg"> Lorna Gautier
            </span>

            <span class="balance">Current Balance <strong>&pound;223.00</strong></span>
        </div>
        ...
        <div class="daysFilter">
            <div class="fixedFilter">
                <ul class="list-unstyled clearfix">
                    <li>
                        <input type="radio" name="limited" hidden id="oneWeek">
                        <label for="oneWeek">1 Week</label>
                    </li>
                    <li>
                        <input type="radio" name="limited" hidden id="days30">
                        <label for="days30">30 Days</label>
                    </li>
                    <li>
                        <input type="radio" name="limited" hidden id="days90">
            ...
            <div class="dateRangeFilter">
                <input type="text" placeholder="Choose Date Range">
        ...
        <div class="scrollArea">
            <div class="content">
                <div class="generalListing doubleShade">
                    <section>
                        <ul class="list-unstyled clearfix">
                            ...
                            <li style="width:calc(100% - 400px);">
                                ...
                                Recita-Flute & Frets Duo
                            </li>
                            <li style="width:90px;" class="text-right">
                                <span class="title">Funds Out</span>
                                &pound;1.50
                            </li>
                            <li style="width:90px;" class="text-right">
                                <span class="title">Funds In</span>
                                -
                            </li>
                            <li style="width:120px;" class="text-right">
                    ...
                    <section>
                        <ul class="list-unstyled clearfix">
                            ...
                            <li style="width:calc(100% - 400px);">
                                <span class="title">Description</span>
                                - <span class="differentNote">(Top-up Request Sent)</span>
                            </li>
                            <li style="width:90px;" class="text-right">
                                <span class="title">Funds Out</span>
                                &pound;1.50
    ...
    <div class="pop" id="createNewFunds">
        <div>
            <section>
                <article style="width:550px;">
                    <i class="popFuse"></i>
                    <span class="title">New Funds In / Out</span>
                    ...
                    <div class="newForm">
                        <ul class="list-unstyled clearfix col3">
                            ...
                            <li>
                                <span class="title">Choose Funds Type</span>
                                <select>
                                    <option>Funds In</option>
                                    <option>Funds Out</option>
                                </select>
                            </li>
                            <li>
                                <span class="title">Amount (&pound;)</span>
                                <input type="number">
                            </li>
    ...
    <script>
        $('.new').click(function(){
            $('#createNewFunds').css('display', 'table');
        });
