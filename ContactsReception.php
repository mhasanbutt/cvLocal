...
<body>
        ...
        <div class="clearfix">
            ...
            <div class="pull-right clearfix">
                <div class="btn-group noAlergy">
                    <button type="button" class="btn orange"><img src="images/plus.svg" class="svg">Add New Contact</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="contentBody">
        <div class="scrollArea">
            <div class="content">
              	<div class="inBodyForm form-horizontal">
					<div class="row">
						<div class="col-md-4 pull-right">
							<div class="form-group">
								<label class="col-md-4 control-label">My Contacts</label>
								<div class="col-md-8">
									<div class="select">
										<select>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Peter Brimsby</td>
                            <td>Handyman</td>
                            <td>p.brimsby@gmail.com</td>
                            <td>0835923325</td>
                            <td>0835923325</td>
                            <td>0835923325</td>
                            <td>Interested in applying for Job</td>
                        </tr>
                    </tbody>
                </table>
            </div>
