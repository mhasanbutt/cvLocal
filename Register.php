        ...
        <div class="clearfix">
            ...
            <div class="pull-right clearfix">
                <div class="btn-group noAlergy">
                    <button type="button" class="btn orange"><img src="images/plus.svg" class="svg">New Service User</button>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <tbody>
                        <tr>
							...
							<td class="text-center"><a href="#" class="view"><img src="images/view.svg" class="svg"></a></td>
                       		<td class="text-center"><a href="#" class="qview"><img src="images/pencil.svg" class="svg"></a></td>
                        </tr>
                        <tr>
                            <td>Mrs Bertha Green</td>
                            <td>10</td>
