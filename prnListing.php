...
<body>
    ...
    <section class="contentHeader">
        <div class="breadcrumbTitle">
            ...
            <span class="title">PRN History</span>
        </div>
        ...
        <div class="clearfix">
            ...
            <div class="pull-right clearfix">
                ...
                <div class="btn-group">
                    <button type="button" class="btn"><img src="images/plus.svg" class="svg">New</button>
                </div>
            </div>
        </div>
    </section>
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Strength</th>
                            <th>Dosage</th>
                            <th>Purpose of Administration</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>200mg</td>
                            <td>2 Units</td>
                            <td>To cater the chilling sensation in spine</td>
                            <td>07-09-2017</td>
                            <td>09-09-2017</td>
                            <td>Dr. Who</td>
