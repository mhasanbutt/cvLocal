...
<body>
    ...
    <section class="contentHeader">
        <div class="breadcrumbTitle">
            ...
            <span class="title">Staff Enquiry</span>
        </div>
    </section>
                                ...
                                <form class="inBodyForm">
									...
									<div class="row">
                               		...
                               		<div class="row">
                                        ...
                                        <div class="col-md-8">
											<div class="form-group">
                                                <label>Position Applied for (You can select multiple position)</label>
                                                <div class="select">
                               		...
                               		<div class="row">
                              			...
                              			<div class="col-md-4">
											<div class="form-group">
                                                <label>How did you hear about the vacancy</label>
                                                <div class="select">
													<select>
														<option>Select</option>
                               		...
                               		<div class="row">
                               			<div class="col-md-6">
											<div class="form-group">
                                                <label>Please give Family/Children details. </label>
                                                <textarea placeholder=""></textarea>
											</div>
                              			</div>
                              			<div class="col-md-6">
											<div class="form-group">
                                                <label>Details of Current Job/Notice Details0</label>
                                                <textarea placeholder=""></textarea>
                               		...
                               		<div class="row">
                               			...
                               			<div class="col-md-4">
											<div class="form-group">
                                                <label>How long did you work in your last job?</label>
                                                <input type="text">
											</div>
                              			</div>
                               			<div class="col-md-4">
                              			...
                              			<div class="col-md-4">
											<div class="form-group">
												...
												<div class="select">
													<select>
														<option>Select</option>
														<option>Request for CV Sent</option>
														<option>Interview Arranged</option>
