...
<body>
    ...
    <section class="contentHeader">
        <div class="breadcrumbTitle">
            ...
            <span class="title">Feedback History</span>
        </div>
        ...
        <div class="clearfix">
            ...
            <div class="pull-right clearfix">
                <div class="btn-group noAlergy">
                    <button type="button" class="btn"><img src="images/plus.svg" class="svg">Add Assessment</button>
                </div>
            </div>
        </div>
    </section>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>10-30-00</td>
                            <td>Lorem Ipsum</td>
                            <td>Terrence McConville</td>
                            <td align="center"><div class="cancled">Cancle <br><button type="button" class="btn btn-primary">Feedback</button></div></td>
                        ...
                        <tr>
                            ...
                            <td>Lorem Ipsum</td>
                            <td>Terrence McConville</td>
                            <td align="center"><div class="unsuccessful">unsuccessful <br><button type="button" class="btn btn-primary">Feedback</button></div></td>
                            <td><a href="#" class="view"><img src="images/view.svg" class="svg"></a></td>
                        </tr>
                        <tr>
                            <td>Mrs Bertha Green</td>
